...
export default function Home() {
  ...
  const lottoSchedules = {
    ...
    lao: {
      time: "ทุกวันจันทร์ วันพุธ และวันศุกร์ | เวลา 20:00 น. - 20:30 น. (รอบย่อยออกทุกวัน)",
      nextDraw: "17 กรกฎาคม 2569 (วันพรุ่งนี้)",
      flag: "🇱🇦",
      title: "หวยลาว (ลาวสตาร์, ลาวพัฒนา, ลาวสามัคคี)",
      details: "หวยลาวพัฒนามีรอบหลักสัปดาห์ละ 3 วัน ส่วนลาวสตาร์และสามัคคีออกประกาศผลทุกวัน"
    },
    hanoi: {
